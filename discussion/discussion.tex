...
In addition, it is helpful to judge any MR in the background of the Brandford Hill criteria~\cite{Hill1965} to evaluate the plausibility of any causal connection.
I will briefly outline each criteria in the context to MR~\cite{Burgess2016a}.
...
In addition, MR estimates are usually of small effect (see Chapter~\ref{cha:assocation_study_in_agggressive_behavior_and_risk_taking}). 
...
Considering these, more common-sense, aspects to evaluate MR there has been some scepticism about the general usage of MR~\cite{Thomas2010,Hemani2016,Brion2014,Voight2014,Burgess2016,Burgess2016a}. 
Specifically, many MR analysis make use of a statistical driven approach to select SNPs as instrumental variables.
