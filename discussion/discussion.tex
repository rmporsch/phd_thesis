...
While I was able to replicate previous findings in regards to risk taking~\cite{Day2016}, I was unable to identify any genome-wide signal for impulsive aggression.
...
To conclude, while MR often has been described in terms of randomized control trials there are some important differences.
...
The most liberal approach is to use all available SNPs within the whole genome.
