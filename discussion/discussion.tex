...
In contrast to risk taking I was unable to identify any genome wide associations for impulsive aggression while I estimated the heritability of aggressive behavior between 50--80\% (see Chapter~\ref{chap:longHera}).
...
The data obtained by~\citet{Pappa2016a}, as well as those used in Chapter~\ref{chap:longHera} are based on multi-question instruments, commonly used with multiple raters.
