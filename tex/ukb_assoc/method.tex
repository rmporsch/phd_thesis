...
Within this dataset the two variable of interest are impulsive aggression and risk taking.
...
Within this chapter I computed the empirical cumulative distribution function on nominal p-values of phenotype A conditional on p-values of phenotype B passing a given threshold~\cite{Andreassen2013}.
