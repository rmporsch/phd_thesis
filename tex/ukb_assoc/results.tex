...
Sex and age of participants is affecting both main and secondary phenotypes.
However, while effects of both age and sex are significant these effects are rather small (see Figure~\ref{fig:disc}).
Nevertheless, one can observe noticeable sex differnces in risk taking, alcohol consumption as well as neuroticism.
...
\begin{figure}[htpb]
  ...
  \caption{
    Descriptive Statistics of primary and secondary phenotypes.
...
Genome wide association analysis reveled no genome wide significant loci in $37,320$ subjects (see Figure~\ref{fig:gwas_impAgg}).
...
\begin{figure}[!htpb]
  \begin{subfigure}[t]{.5\textwidth}
    \centering
    \includegraphics[width=0.8\linewidth]{{figure/qq_plots/qq_plot_4526}.jpeg}
    \caption{QQ-plot for Impulsive aggression}\label{fig:ImpAgqq}
  \end{subfigure}
  \begin{subfigure}[t]{.5\textwidth}
    \centering
    \includegraphics[width=0.8\linewidth]{{figure/manhatten_plots/manhatten_plot_4526}.jpeg}
...
which indicates the proportion of inflation to factors other than polygenic heritability, is with $0.0422$ ($SE=0.052$) low.
...
\begin{figure}[!htpb]
	\begin{subfigure}{.5\textwidth}
		\centering
		\includegraphics[width=0.8\linewidth]{{figure/qq_plots/qq_plot_2040}.jpeg}
		\caption{QQ-Plot of risk taking.}\label{fig:riskqq}
	\end{subfigure}
	\begin{subfigure}{.5\textwidth}
		\centering
		\includegraphics[width=0.8\linewidth]{{figure/manhatten_plots/manhatten_plot_2040}.jpeg}
		\caption{
  ...
  \caption{QQ and Manhattan plot for Risk Taking. 
    Two separate genome wide significant loci were identified, while a third is marginal significant.\label{fig:risktaking_gwas}}
\end{figure}
