...
However, many mammals are social animals, e. g. human, and a display of aggressive behavior can result in negative social consequences %TODO cite.
...
\begin{figure}
	\scalebox{0.8}{
	\input{"introduction/figure/stabilizingSelectionSchematic.tex"}
}
\end{figure}
