...
Within this introductory chapter I will first give a definition of aggression as well as review current evolutionary theories in regards to this complex behavior.
Following, I will give an overview of known genetic factors related to this complex behavior.
Subsequent to this chapter I will give an overview of the statistical methods used within this thesis.
This is followed by large study on over 28,000 twin pairs to investigate the longitudinal heritability of childhood aggression.
Next I will investigate specific molecular genetic marker associated with risk taking and aggression.
Following I will examine the genetic overlap of various traits with aggressive behavior.
I will then outline a newly developed method to test for distributional differences of rare mutation between aggressive and non-aggressive subjects.
...
These sex differences have been discussed in the context of \acrafull{sst}~\cite{Archer2004,Anderson2002,Archer2009}. 
...
These studies have been a popular method to investigate the genetic contribution of a variety of different phenotypes and I will outline a detailed description of this particular method in Section~\ref{chap:longHera}. %TODO as well as the other section in the method chapter
...
For example,~\citet{Hohmann2009} identified an association between a \acrafull{vntr} and externalizing behavior in the dopamine D4 receptor (\textit{DRD4}) gene.
...
In particular the effects of \textit{MAOA} and serotonin transporters have been show to be dependent on the individuals previous experiences.
