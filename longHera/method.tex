...
For the current analysis data of maternal rating at ages 7, 10, and 12 were analyzed for twins born between 1986 and 2005.
...
Sex-differences in parameter estimates (effects of A, C and E) were tested by comparing models that allowed for sex differences in variance components to models that constrained these estimates to be the same, as well as to a scalar model in which male variance components were proportional to female variance components.
