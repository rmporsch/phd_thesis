...
\begin{table}[hbt]
  \centering
  \adjustbox{max width=\columnwidth}{\input{tables/descriptives.tex}}
...
\begin{table}
  \centering
  \adjustbox{max width=\columnwidth}{\input{tables/corss_corr.tex}}
...
\begin{table}
  \centering
  \adjustbox{max width=\columnwidth}{\input{tables/models.tex}}
...
\begin{table}
  \centering
  \adjustbox{max width=\columnwidth}{\input{tables/variance_components.tex}}
...
\begin{table}
  \centering
  \adjustbox{max width=\columnwidth}{\input{tables/hera_better.tex}}
...
\begin{table}
  \centering
  \adjustbox{max width=\columnwidth}{\input{tables/genetic_corr.tex}}
