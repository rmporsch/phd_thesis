...
Aggressive behavior is also implicated in neurodevelopmental disorders such as \arcfull{adhd}~\cite{Hamshere2013, Monuteaux2009} and \arcfull{aspd}~\cite{Nouvion2007, Schaeffer2003}.
...
There was no evidence for qualitative sex differences, as assessed by maternal ratings on the \arcfull{cbcl} aggression subscale, although sex differences in mean scores were large.
...
\citet{Eley1999} were unable to detect sex-differences in the genetic architecture for aggression assessed by the \arcfull{sdq} which was completed by parents in Swedish (aged 7 to 9) and British (aged 8--16) cohorts of 1,022 and 501 twin pairs respectively.
