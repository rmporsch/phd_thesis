...
Specifically, while the minor allele in \textit{rs76395182} is less common in affected (0.330) than unaffected individual (0.344) the opposite is the case in \textit{rs13084531} (0.233 versus 0.222).
...
Pleiotropy informed \arcfull{cfdr} was used to identify additional genetic loci associated with risk taking or impulsive aggression.
...
\begin{table}[htpb]
  \input{ukb_assoc/tables/risk_cFDR.tex}
  \caption{
