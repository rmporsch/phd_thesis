...
One can then calculate the \arcfull{ECDF} for both cases ($F_{A(G)}$) and controls ($F_{U(G)}$) or any other dichotomous phenotype.
...
\begin{figure}[htpb]
  \centering
  \includegraphics[width=0.8\linewidth]{figures/imputation_qc.png}
