...
Examples of this methods include the \arcfull{cmc} test~\cite{Li2008}, as well as the weighted sum statistic~\cite{Madsen2009}.
...
To do so I make use of the well known \arcfull{ks} test.
