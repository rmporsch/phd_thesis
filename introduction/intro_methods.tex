...
However, only recently studies were able to examine the effect of SNPs on a specific trait.
Previous efforts made use of genome-wide linkage studies to identify disease causing mutations.
...
This allows to easily track a certain gene throughout a family.
Thus the presents of the maker in affected, but absents healthy family members allows the identification of causing genes~\cite{DawnTeare2005}. 
